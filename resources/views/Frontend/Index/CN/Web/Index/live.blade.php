...
<head>
    ...
    <script src="{{asset('assets/frontend/index/web/js/jquery-1.8.3.min.js')}}" type="text/javascript"></script>
    <link rel="stylesheet" href="{{asset('assets/frontend/index/web/css/DialogBySHF.min.css')}}">
    <script src="{{asset('assets/frontend/index/web/js/DialogBySHF.min.js')}}" type="text/javascript"></script>
    <script src="{{asset('assets/frontend/index/web/js/qrcode.js')}}"></script>
</head>
<body>
<style>
    .article .erweima{
    ...
    <div class="_article">
        <div class="article">
            ...
            <div class="article_con">
                ...
                <a href="{{url("index/report")}}?id={{$id}}"><h5>查看服务报告示例<i></i></h5></a>
            </div>
            <h6>支付方式</h6>
            <div class="zhifu">
                <!--<a href="###"><i></i></a>-->
            ...
            <div class="zhifujin">
                ...
                {{--<a id="pay" onclick="pay()"><button>去支付</button></a>--}}
               {{-- <a href="{{url("index/success")}}"><button>去支付</button></a>--}}
            </div>
