...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets/frontend/index/web/css/common.css')}}" type="text/css">
    <link href="{{asset('assets/frontend/index/web/css/layui.css')}}" rel="stylesheet" type="text/css" />
...
<div class="wrap">
    <div class="header">
        <img src="{{URL::asset('assets/frontend/index/web/images/wechat/01.png')}}">
        <img class="marginT" src="{{URL::asset('assets/frontend/index/web/images/wechat/02.png')}}">
        <img class="marginT" src="{{URL::asset('assets/frontend/index/web/images/wechat/03.png')}}">
        <img class="marginT" src="{{URL::asset('assets/frontend/index/web/images/wechat/04.png')}}">
        <img class="marginT" src="{{URL::asset('assets/frontend/index/web/images/wechat/05.png')}}">
        <img class="marginT" src="{{URL::asset('assets/frontend/index/web/images/wechat/06.png')}}">
        <img class="marginT" src="{{URL::asset('assets/frontend/index/web/images/wechat/07.png')}}">
        <img class="marginT" src="{{URL::asset('assets/frontend/index/web/images/wechat/08.png')}}">
        <img class="marginT" src="{{URL::asset('assets/frontend/index/web/images/wechat/09.png')}}">
        <img class="marginT" src="{{URL::asset('assets/frontend/index/web/images/wechat/10.png')}}">
        <img class="marginT" src="{{URL::asset('assets/frontend/index/web/images/wechat/11.png')}}">
        <img class="marginT" src="{{URL::asset('assets/frontend/index/web/images/wechat/12.png')}}">
        <img class="marginT" src="{{URL::asset('assets/frontend/index/web/images/wechat/13.png')}}">
        <img class="marginT" src="{{URL::asset('assets/frontend/index/web/images/wechat/14.png')}}">
        <img class="marginT" src="{{URL::asset('assets/frontend/index/web/images/wechat/15.png')}}">
        <img class="marginT" src="{{URL::asset('assets/frontend/index/web/images/wechat/16.png')}}">
        <img class="marginT" src="{{URL::asset('assets/frontend/index/web/images/wechat/17.png')}}">
        <img class="marginT" src="{{URL::asset('assets/frontend/index/web/images/wechat/18.png')}}">
        <img class="marginT" src="{{URL::asset('assets/frontend/index/web/images/wechat/19.png')}}">
        <img class="marginT" src="{{URL::asset('assets/frontend/index/web/images/wechat/20.png')}}" id="showButton">
    </div>
    {{--<div class="wagesBtn lf-tb-center" data-go="open" id="wagesBtn">--}}
        {{--<a href="javascript:;">开启计划 积累幸福</a>--}}
    {{--</div>--}}

    {{--<div class="wechat-assessment" id="showButton">--}}
        {{--<img src="{{URL::asset('assets/frontend/index/web/images/wechat/assessment.png')}}">--}}
    {{--</div>--}}
                        ...
                        <select name="category" class="layui-input" id="data-category">
                            ...
                            @if(isset($category) && !empty($category))
                                @foreach($category as $key=>$value)
                                    <option value="{{$value->id}}" style="display: block">{{$value->title}}</option>
                                @endforeach
                            @endif
    ...
    {{--<script src="{{asset('assets/frontend/index/web/js/jquery.mobile-1.4.5.min.js')}}" type="text/javascript"></script>--}}
    <script>
