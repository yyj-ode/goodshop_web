        ...
        <div class="iask_navigator">
            ...
            @if(isset($allData['categoryLinkData']) && !empty($allData['categoryLinkData']))
                @foreach($allData['categoryLinkData']  as $key => $value)
                    <span>&gt;</span>
                    <a href="{{url('question'.DIRECTORY_SEPARATOR.'c'.$value['id'].'s'.$allData['status'].'p1.html')}}">{{$value['category_name']}}</a>
                @endforeach
            @endif
        </div>
        ...
        <ul class="w645 left">
            <div class="iask09">
                <div class="iask09_tag">
                    ...
                    <p><a href="/question/list-595.html" style="padding:0 4px 0 10px;font-size:14px">呼吸科</a></p>
                    <span style="display:;">|</span>

                    <p><a href="/question/list-596.html" style="padding:0 4px;font-size:14px">内分泌科</a></p>
                    <span style="display:;">|</span>

                    <p><a href="/question/list-597.html" style="padding:0 4px;font-size:14px">神经内科</a></p>
                    <span style="display:;">|</span>

                    <p class="curr"><a href="/question/list-598.html" style="padding:0 4px;font-size:14px">消化内科</a></p>
                    <span style="display:;">|</span>

                    <p><a href="/question/list-599.html" style="padding:0 4px;font-size:14px">心血管内科</a></p>
                    <span style="display:;">|</span>

                    <p><a href="/question/list-600.html" style="padding:0 4px;font-size:14px">血液科</a></p>
                    <span style="display:;">|</span>

                    <p><a href="/question/list-601.html" style="padding:0 4px;font-size:14px">肾内科</a></p>
                    <span style="display:;">|</span>

                    <p><a href="/question/list-602.html" style="padding:0 4px;font-size:14px">感染内科</a></p>
                    <ul style="right:0;"></ul>
                </div>
                <div class="iask09_con">
                    <a href="/question/list-40.html"><p>胆囊息肉</p></a>
                    <a href="/question/list-221.html"><p>腹泻</p></a>
                    <a href="/question/list-222.html"><p>肠炎</p></a>
                    <a href="/question/list-333.html"><p>结石病</p></a>
                    <a href="/question/list-344.html"><p>胃病</p></a>
                    <a href="/question/list-404.html"><p>消化不良</p></a>
                    <a href="/question/list-578.html"><p>便秘</p></a>
                    <a href="/question/list-626.html"><p>其他消化疾病</p></a>
                </div>
            </div>
            <div class="iask10">
                <div class="iask10_tag">
                    <ul @if($allData['status']==6)class="curr" @endif><a href="{{url('question/c'.$allData['category_id'].'s6p1.html')}}">全部问题</a></ul>
                    <ul @if($allData['status']==8)class="curr" @endif><a href="{{url('question/c'.$allData['category_id'].'s8p1.html')}}">已采纳问题</a></ul>
                ...
                <div class="iask10_con">
                    ...
                    <ul>
                        <li class="iask10a">
                            <span>[<a href="{{url('question'.DIRECTORY_SEPARATOR.'c'.$value['category_id'].'s'.$allData['status'].'p1.html')}}" class="link03" title="{{$value['category_name']}}">{{$value['category_name']}}</a>]</span>
