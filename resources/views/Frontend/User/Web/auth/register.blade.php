...
@section('content')
    <div style="margin: 15px;">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="password" name="password" id="xpass1" lay-verify="password"  autocomplete="off" placeholder="请输用户名称" class="layui-input" value="">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">确认密码</label>
            <div class="layui-input-block">
                <input type="password" name="qrpassword" id="xpass2" lay-verify="password"  autocomplete="off" placeholder="请输用户名称" class="layui-input" value="">
            </div>
        </div>
        <div class="layui-form-item">
