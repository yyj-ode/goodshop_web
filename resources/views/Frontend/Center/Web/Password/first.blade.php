                ...
                <div class="form" style="margin-left: 258px;">
                    <div class="item">
                        ...
                        <div class="fl">
                            ...
                            <b><a href="/validate/password/updatePassword.action?type=email"><font color="#0000FF">通过已验证邮箱验证</font></a></b>&nbsp;&nbsp;
                            <b><a href="/validate/password/updatePassword.action?type=payPwd"><font color="#0000FF">通过支付密码验证</font></a></b>&nbsp;&nbsp;
                            <div class="clr"></div>
                        </div>
                        <div class="clr"></div>
                    </div>
