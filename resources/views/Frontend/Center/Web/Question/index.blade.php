            ...
            <div class="layui-tab-item layui-show">
                <div class="layui-main">
                    <table class="layui-table" lay-even="" lay-skin="nob">
                        ...
                        <tr>
                            <td><a href="{{url('question/s'.$value['id'].'.html')}}">{{$value['id']}}</a></td>
                            <td><a href="{{url('question/s'.$value['id'].'.html')}}">{{$value['title']}}</a></td>
                            <td>{{$value['description']}}</td>
                            <td>已完成</td>
                            <td>{{$value['created_at']}}</td>
                            <td>
                                <a href="javascript:;" data-id="{{$value['id']}}" class="link01b supplyBtn">补充问题</a>
                                <span>|</span>
                                <a href="{{url('question/s'.$value['id'].'.html')}}" target="_blank" class="link01b">查看回答</a>@if(isset($value['number'])) ({{$value['number']}}) @endif
                            </td>
                        </tr>
                        @endforeach
                        @endif
