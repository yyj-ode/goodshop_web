...
<div id="main">
    <div class="mod-main">
        <div class="mt">
            <ul class="extra-l">
                <li class="fore-1"><a class="curr" href="javascript:void(0);">编辑收货地址</a></li>
            </ul>
        </div>
        <div class="mc">
            <div class="user-set userset-lcol">
                <div class="form">
                    <div class="item">
                        ...
                        <div class="fl">
                            <input class="ivu-input" type="text" style="width: 300px;" value="杨斌">
                        </div>
                    </div>
                    <div class="item">
                            ...
                            <div slot="demo">
                                <div style="width:150px" class="ivu-select ivu-select-single">
                                    <div class="ivu-select-selection">
                                        <span class="ivu-select-placeholder">北京</span>
                                ...
                                <div style="width:150px" class="ivu-select ivu-select-single">
                                    <div class="ivu-select-selection">
                                        <span class="ivu-select-placeholder">北京市</span>
                                        <span class="ivu-select-selected-value" style="display: none;"></span>
                                        <i class="ivu-select-arrow ivu-icon ivu-icon-ios-close" style="display: none;"></i>
                                        <i class="ivu-select-arrow ivu-icon ivu-icon-arrow-down-b"></i>
                                    </div>
                                ...
                                <div style="width:150px" class="ivu-select ivu-select-single">
                                    <div class="ivu-select-selection">
                                        <span class="ivu-select-placeholder">朝阳区</span>
                                        <span class="ivu-select-selected-value" style="display: none;"></span>
                                        <i class="ivu-select-arrow ivu-icon ivu-icon-ios-close" style="display: none;"></i>
                                        <i class="ivu-select-arrow ivu-icon ivu-icon-arrow-down-b"></i>
                                    </div>
                    ...
                    <div class="item">
                        ...
                        <div class="fl">
                            <input class="ivu-input" type="text" style="width:400px" value="管庄北一里">
                        </div>
                    </div>
                    <div class="item">
                        <span class="label"><em>*</em>手机号码：</span>
                        <div class="fl">
                            <input class="ivu-input" type="text" style="width:300px" value="13911052021">
                        </div>
                    </div>
                    <div class="item">
                    ...
                    <div class="item">
                        ...
                        <div class="fl">
                            <input class="ivu-input" type="text" style="width:300px" value="yangcuiwang@gmail.com">
                        </div>
                    </div>
                    <div class="item">
                        <span class="label">邮编：</span>
                        <div class="fl">
                            <input class="ivu-input" type="text" style="width:300px" value="100010">
                        </div>
                    </div>
