        ...
        <div class="shop_mess">
            ...
            <div class="shop_choice">
                ...
                <div class="kuang none">
                    <ul>
                        <li val="type_restaurant_catering">酒楼餐饮</li>
                        <li val="type_shoes_bag">服饰鞋包</li>
                        <li val="type_beauty_salon">美容美发</li>
                        <li val="type_recreation">休闲娱乐</li>
                        <li val="type_life_service">生活服务</li>
                        <li val="type_store">百货超市</li>
                        <li val="type_materials">家居建材</li>
                        <li val="type_communication">电气通讯</li>
                        <li val="type_auto">汽修美容</li>
                        <li val="type_medical_care">医药保健</li>
                        <li val="type_training">教育培训</li>
                        <li val="type_am_turm">旅游宾馆</li>
                        <li val="type_formats">其他业态</li>
                ...
                <div class="kuang none">
                    <ul>
                        <?php $__currentLoopData = $subscribe['format']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li val="<?php echo e($value['id']); ?>"><?php echo e($value['name']); ?></li>
                                    ...
                                    <?php $__currentLoopData = $subscribe['area_level']['area_level3']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k3 =>$v3): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($k2 == $k3): ?>
                                            ...
                                            <?php $__currentLoopData = $v3; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k4 => $v4): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <li countyid="<?php echo e($v4['id']); ?>"><?php echo e($v4['name']); ?></li>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php endif; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </ul>
                ...
                <div class="kuang none">
                    <ul>
                        <?php $__currentLoopData = $subscribe['totalarea']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li id="<?php echo e($value['id']); ?>" min_area="<?php echo e($value['min_area']); ?>" max_area="<?php echo e($value['max_area']); ?>"><?php echo e($value['string']); ?>㎡</li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
                </div>
            </div>
                ...
                <div class="kuang none">
                    <ul>
                        <?php $__currentLoopData = $subscribe['price']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li id="<?php echo e($value['id']); ?>" min_price="<?php echo e($value['min_price']); ?>" max_price="<?php echo e($value['max_price']); ?>"><?php echo e($value['string']); ?>㎡</li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
                </div>
            </div>
...
<input type="hidden" id="subscribe_city" value="">
<input type="hidden" id="subscribe_county" value="">