...
//            dd(session('USER_DATA'));
        ...
        if ($this->is_mobile() == true) {
            return view('Frontend.Index.CN.Wap.Detail.index',compact('data','user_login','price','totalarea','format','area_level','officebuilding_num','village_num','collection_status','subscribe','shoppingcenter_num','shopsurrounding_num'));
