...
class Area extends BaseModel
{
    ...
    {
        return self::where('parent_id', $parent_id)->where(['show' => 1])->get();
    }

    public static function getByParentIds($parent_ids)
    {
        return self::whereIn('parent_id', $parent_ids)->where(['show' => 1])->get();
    }
    ...
    public static function unlimited_category($parent_id = 0)
    {
